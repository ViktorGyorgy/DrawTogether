...
After every player has finished their drawing, the voting phase begins. Each player has to choose one of the other players' artwork, which they find the most funny/creative. The player with the most votes gets a point.
...
- **Authorization**: the user can see some stats about themself (how many games they played). Every player can see only their stats.
...
# What I would do differently if I would redo the project
